...
var strUser = e.options[e.selectedIndex].value;
  ...
  {
    document.getElementById("answer").value=data[ind].name+" favorite color is "+data[ind].color;
  }

  if(/movie/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" favorite movie is "+data[ind].movie;
  }

  if(/place/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" favorite place is "+data[ind].place;
  }

  if(/actor/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" favorite actor is "+data[ind].actor;
  }

  if(/sport/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" favorite sport is "+data[ind].sport;
  }

  if(/food/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" favorite food is "+data[ind].food;
  }

  if(/vehicle/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" favorite vehicle is "+data[ind].vehicle;
  }

  if(/actress/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" favorite actress is "+data[ind].actress;
  }
  if(/domain/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" works in "+data[ind].domain +" domain" ;
  }
  if(/skill/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" is skilled in "+data[ind].skill;
  }
  if(/company/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" favorite company is "+data[ind].company;
  }
  if(/experience/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" has an experience of "+data[ind].experience+" years";
  }
  if(/marital/i.test(que)==true)
  {
    document.getElementById("answer").value=data[ind].name+" is "+data[ind].marital;
  }
